...
const Footer = () => {
  ...
  return (
    <footer className="relative -left-[calc(50vw-50%)] w-screen overflow-hidden px-8 py-10 text-(--text-primary)">
      ...
      <div className="relative z-10">
        <div className="mb-12 flex flex-col items-center gap-8">
          ...
          <a
            href={`mailto:${email}`}
            className="flex items-center gap-3 text-base font-medium transition-colors duration-200 hover:text-(--accent)"
          >
        ...
        <div className="mx-auto w-full max-w-300 px-8">
