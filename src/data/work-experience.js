...
export const workExperiences = [
  {
    ...
    location: "Singapore",
    description:
      "Joined the NCS Fusion Work-Study Degree Programme as a Software Engineer, developing software solutions while pursuing a sponsored Bachelor's Degree from a recognised university.",
    responsibilities: [
